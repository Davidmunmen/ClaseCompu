...
// previo 5
//Fecha de entrega 113 de Septiembre de 2026
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		color = glm::vec3(0.0f, 1.0f, 0.5f);//vector de color para cada cuadrado
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Palma
		model = glm::translate(modelTemp, glm::vec3(0.75f, 0.0f, 0.0f));// refresamos al valor anterior de la matriz temporal
		...
		//Dedo3
		model = glm::translate(modelTemp3, glm::vec3(0.25f, 0.35f, -0.35f));
		model = glm::rotate(model, glm::radians(dedo3), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.6f, 0.3f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
